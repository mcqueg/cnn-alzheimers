...
def build_xception(input_shape,
    ...
    '''
    Purpose: 
        Initializes and compiles an xception model with pretrained weights from ImageNet up
    ...
    xception_weights = 'models/raw/xception_weights_tf_dim_ordering_tf_kernels_notop.h5'

    #xception_weights = '/Users/garrettmccue/projects/cnn-alzheimers/models/raw/'\
    ...
    pre_trained_model = Xception(input_shape = input_shape,
                                    include_top= False,
                                    weights = None)
    # load pretrained weights
    print(f'Loading resnet50 weights from:\n\t PATH = {xception_weights}...')
    pre_trained_model.load_weights(xception_weights)
